...
> **v3.3 Architecture Note:** In v3.3, most orchestration happens through **skills** loaded on-demand by Claude. The agents documented here are invoked automatically by the **workflow skill** via the Task tool. You don't call them directly - just describe what you want.
>
