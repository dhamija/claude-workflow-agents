...
> **v3.0 Architecture:** Workflow orchestration now happens via the **workflow skill** loaded on-demand by Claude. Skills + Hooks + Subagents architecture for 90% context reduction.
