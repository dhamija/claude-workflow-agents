...
**Important (v3.3):** This is NOT operational documentation. Orchestration logic is in the **workflow skill** (`templates/skills/workflow/SKILL.md`), NOT in project CLAUDE.md files.
...
### Current Architecture (v3.3 - Skills + Hooks)
...
- Deprecated in v3.3 due to context bloat
