...
echo "   - Update AGENTS.md with new agent definitions"
echo "   - Update COMMANDS.md with new command definitions"
echo "   - Update EXAMPLES.md if workflow examples change"
echo ""
